	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_radoyv4_caption)#",
					"color": "default",
					"disabled": false,
					"size": "medium",
			...
			{
				"operation": "insert",
				"name": "RunAvgPriceProcess",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(RunAvgPriceProcess_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrDriveType_j9f90n5;
